...
public class TriasTest {
	...
	public void test13() throws IOException {
		...
		trias.setMinSupportPerDimension(new float[]{0,0,0});
	...
	private void checkResult(final int[][] itemList, final int[][][] trueConcepts, final int[] minSupp) throws IOException {
		...
		final SortedSet<String> computedConcepts = new TreeSet<String>();
                float[] casted_minsupp = convertIntToFloats(minSupp);
		final TriasConfigurator config = new TriasJavaConfigurator(itemList, casted_minsupp, computedConcepts);
		final Trias trias = new Trias();
        ...
        public static float[] convertIntToFloats(int[] input)
        {
            if (input == null)
            {
